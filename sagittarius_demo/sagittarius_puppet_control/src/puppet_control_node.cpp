#include <ros/ros.h>
#include "sagittarius_sdk/OperatingModes.h"
#include "sagittarius_sdk/JointCommands.h"
#include "sagittarius_sdk/RobotInfo.h"
...
int main(int argc, char **argv)
{
  ...
  ros::Publisher pub_positions = n.advertise<sagittarius_sdk::JointCommands>(robot_name_2 + "/joint/commands", 100);
  ...
  ros::ServiceClient srv_op_mode = n.serviceClient<sagittarius_sdk::OperatingModes>(robot_name_2 + "/set_operating_modes");
  // Get some robot info to figure out how many joints the robot has
  ros::ServiceClient srv_robot_info = n.serviceClient<sagittarius_sdk::RobotInfo>(robot_name_1 + "/get_robot_info");
  ...
  sagittarius_sdk::OperatingModes op_srv;
  op_srv.request.cmd = sagittarius_sdk::OperatingModes::Request::ARM_JOINTS_AND_GRIPPER;
  ...
  sagittarius_sdk::RobotInfo robot_info_srv;
  ...
  while (ros::ok())
  {
    ...
    sagittarius_sdk::JointCommands pos_msg;
