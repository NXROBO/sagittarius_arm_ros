...
#include "sagittarius_perception_modules/FilterParams.h"
#include "sagittarius_perception_modules/ClusterInfo.h"
#include "sagittarius_perception_modules/ClusterInfoArray.h"
...
std::vector<sagittarius_perception_modules::ClusterInfo> cluster_info_vector;
...
void perception_pipeline()
{
  ...
  for (std::vector<pcl::PointIndices>::const_iterator it = cluster_indices.begin (); it != cluster_indices.end (); ++it)
  {
    ...
    sagittarius_perception_modules::ClusterInfo ci_msg;
...
bool srv_set_filter_params(sagittarius_perception_modules::FilterParams::Request& req, sagittarius_perception_modules::FilterParams::Response& res)
{
...
// @return <bool> - true if service executed successfully
bool srv_get_cluster_positions(sagittarius_perception_modules::ClusterInfoArray::Request& req, sagittarius_perception_modules::ClusterInfoArray::Response& res)
{
  if (!enable_pipeline)
    perception_pipeline();
