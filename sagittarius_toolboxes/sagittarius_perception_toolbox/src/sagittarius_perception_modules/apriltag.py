...
from sagittarius_perception_modules.srv import SnapPicture
...
class SagittariusAprilTagInterface(object):
    #valid_tags = [5, 413, 820, 875, 1050]
    valid_tags = [341, 875, 908, 1611, 1826]
    v = False
    def __init__(self, apriltag_ns="apriltag", init_node=False, 
        ...
        print("Initialized SagittariusAprilTagInterface!\n")
