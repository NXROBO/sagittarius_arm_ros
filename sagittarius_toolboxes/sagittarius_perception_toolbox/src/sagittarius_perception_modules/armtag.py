...
from sagittarius_perception_modules.apriltag import SagittariusAprilTagInterface
from sagittarius_common_modules import angle_manipulation as ang
...
### @param apriltag_ns - namespace where the ROS parameters needed by the SagittariusAprilTagInterface module are located
...
class SagittariusArmTagInterface(object):
    def __init__(self, armtag_ns="armtag", apriltag_ns="apriltag", init_node=False):
        ...
        self.rpy = [0,0,0]
        self.apriltag = SagittariusAprilTagInterface(apriltag_ns, False)
        print("Initialized SagittariusArmTagInterface!\n")
