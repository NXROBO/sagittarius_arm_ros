...
from sagittarius_perception_modules.srv import *
from sagittarius_perception_modules.msg import ClusterInfo
...
class SagittariusPointCloudInterface(object):
    def __init__(self, filter_ns="pc_filter", init_node=False):
        ...
        print("Initialized SagittariusPointCloudInterface\n")
