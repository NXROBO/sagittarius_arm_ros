...
namespace sdk_sagittarius_arm
{
    ...
    int CSDarmCommonSerial::SendArmEndAction(unsigned char onoff, short value)
    {
        ...
        if(mFd == -1)
        {
            ROS_ERROR("SendArmLockOrFree: Serial NOT open");
            mDiagUpdater.broadcast(diagnostic_msgs::DiagnosticStatus::ERROR,
                                   "sdk_sagittarius_arm - SendArmLockOrFree: Serial NOT open!");
    ...
    int CSDarmCommonSerial::SetArmVel(unsigned short vel)
    {
        ...
        {
            mDiagUpdater.broadcast(diagnostic_msgs::DiagnosticStatus::ERROR,
                                   "sdk_sagittarius_arm - SetArmVel: Serial NOT open!");
    ...
    int CSDarmCommonSerial::SetArmAcc(unsigned char acc)
    {
        ...
        {
            mDiagUpdater.broadcast(diagnostic_msgs::DiagnosticStatus::ERROR,
                                   "sdk_sagittarius_arm - SetArmAcc: Serial NOT open!");
            return ExitError;
        }
        buf[0] = 0x55;						//帧头1 55
        buf[1] = 0xAA;						//帧头2 AA
    ...
    int CSDarmCommonSerial::SetArmTorque(int torque[])
    {
        ...
        {
            mDiagUpdater.broadcast(diagnostic_msgs::DiagnosticStatus::ERROR,
                                   "sdk_sagittarius_arm - SetArmTorque: Serial NOT open!");
            return ExitError;
        }
        buf[0] = 0x55;						//帧头1 55
        buf[1] = 0xAA;						//帧头2 AA
    ...
    int CSDarmCommonSerial::SendArmAllServerTime(short difftime, float v1, float v2, float v3, float v4, float v5, float v6)
    {
        ...
        if(mFd == -1)
        {
            ROS_ERROR("SendArmAllServerTime: Serial NOT open");
            mDiagUpdater.broadcast(diagnostic_msgs::DiagnosticStatus::ERROR,
                                   "sdk_sagittarius_arm - SendArmAllServerTime: Serial NOT open!");
    ...
    int CSDarmCommonSerial::SendArmAllServerCB(float v1, float v2, float v3, float v4, float v5, float v6)
    {
        ...
        if(mFd == -1)
        {
            ROS_ERROR("SendArmAllServerCB: Serial NOT open");
            mDiagUpdater.broadcast(diagnostic_msgs::DiagnosticStatus::ERROR,
                                   "sdk_sagittarius_arm - SendArmAllServerCB: Serial NOT open!");
    ...
    int CSDarmCommonSerial::SendArmAllServer(float v1, float v2, float v3, float v4, float v5, float v6)
    {
        ...
        if(mFd == -1)
        {
            ROS_ERROR("SendArmAllServer: Serial NOT open");
            mDiagUpdater.broadcast(diagnostic_msgs::DiagnosticStatus::ERROR,
                                   "sdk_sagittarius_arm - SendArmAllServer: Serial NOT open!");
    ...
    int CSDarmCommonSerial::GetDataGram(unsigned char* receiveBuffer, int bufferSize, int *length)
    {
        ...
        if(mFd == -1)
        {
            ROS_ERROR("GetDataGram: Serial NOT open");
            mDiagUpdater.broadcast(diagnostic_msgs::DiagnosticStatus::ERROR,
                                   "sdk_sagittarius_arm - GetDataGram: Serial NOT open!");
            return ExitError;
        }
